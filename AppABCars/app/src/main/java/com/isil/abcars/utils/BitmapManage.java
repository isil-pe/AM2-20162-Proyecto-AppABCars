...
public class BitmapManage {
	...
	private static BitmapManage instance = new BitmapManage(); 
	
	public static BitmapManage getInstance(){
		return instance;
	}
		...
		final Handler handler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				if (tag != null && tag.equals(url)) {
					if (msg.obj != null) {
						//imageView.setImageDrawable( new RoundedAvatarDrawable( (Bitmap) msg.obj )  );
	...
	public void loadBitmap(final String url, final ImageView imageView) {
		...
		if (bitmap != null) {
			Log.d("Usando cache:", "Item baixado cool: " + url);
