 ...
 * {@link ListMarcaFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ListMarcaFragment#newInstance} factory method to
...
public class ListMarcaFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        listMarca = (ListView) getView().findViewById(R.id.listMarca);
